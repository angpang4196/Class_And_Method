...
public class Method05 {
	...
	public static void main(String[] args) {
		...
		String strName = ""; // 선언만 된 변수는 null값을 가지고 가정
		...
		/*
		 * 변수를 선언만 할 경우
		 * 변수를 읽을려고 시도하면 오류가 발생할 가능성을 내포하는 code가 된다.
		 * 
		 * 따라서, 당장 어떤 값을 저장하지 않는다면 최소한 int:0, String:"", float:0f, boolean:false 값으로 초기화를 해주는 것이 좋다.
		 */
		int intNum2 = 0;
		String strName2 = "";
