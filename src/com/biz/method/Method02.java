...
public class Method02 {
	...
	public static int addVarReturn(int intNum1, int intNum2) {
		int intSum = intNum1 + intNum2;
		/*
		 * return 문은 method가 코드실행을 모두 끝내거나 중단했을 경우
		 * method를 호출(사용)한 곳으로 메세지를 전달하는 용도로 사용할 수 있다.
		 */
		
		// return 0 ;
		return intSum ;
		// 두개의 정수형 매개 변수값을 전달받은 후 덧셈한 결과가 담긴 intSum 변수를 
		// return 문과 함께 작성하므로 해서 intSum에 보관되어 있는 intNum1 + intNum2의 결과를 호출한 곳으로 메시지로 전달한다.
	}
